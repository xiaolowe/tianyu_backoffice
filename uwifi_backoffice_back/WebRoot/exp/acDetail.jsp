...
<%@page import="com.nanalong.web.backoffice.controller.MyRouterController,com.nanalong.web.backoffice.util.StringUtil"%>
<%
	//关于文件下载时采用文件流输出的方式处理：   
	...
	try {
		MyRouterController ctl = new MyRouterController();
		filePath = ctl.expAcdetail(businessid,acid,starttime, endtime);

		fileName = "路由器运行详细信息-"+StringUtil.getDateStr8()+".xls";
