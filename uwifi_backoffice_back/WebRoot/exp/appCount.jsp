...
<%@page import="com.nanalong.web.backoffice.controller.AppdownloadController,com.nanalong.web.backoffice.util.StringUtil"%>
<%
	//关于文件下载时采用文件流输出的方式处理：   
	...
	try {
		AppdownloadController ctl = new AppdownloadController();
		filePath = ctl.expAppDownloadCount(bussinessidStr,starttime, endtime);

		fileName = "AppDownloadCount-"+StringUtil.getDateStr8()+".xls";
